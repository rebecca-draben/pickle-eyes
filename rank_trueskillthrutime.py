...
Run with: ./rank_trueskillthrutime.py match_data_x.csv
This script is best for mostly isolated pools of players who rarely have players play each other (like in a tournament of champions)
"""
